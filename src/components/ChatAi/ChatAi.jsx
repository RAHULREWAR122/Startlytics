...
function ChatAi() {
  ...
  return (
    <div className="fixed bottom-4 right-8 z-50 ">
      <div  className={`
        absolute md:h-[65vh] h-[60vh] bottom-20 md:right-0 right-[-13px]  md:w-96 w-[300px] bg-gray-800 rounded-2xl shadow-2xl border border-gray-200
        custom_scrollbar
      ...
      `} style={{background : background.primary }}>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 custom_scrollbar" style={{ height: 'calc(60vh - 135px)' }}>
        ...
        <div className="p-4 border-t border-gray-300">
          <div className="flex justify-between">
            <input
              ...
              className="w-[70%] flex-1 px-4 py-2 border text-white border-gray-400 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
            />
            <button
              onClick={handleSendMessage}
              disabled={!inputValue.trim() || isLoading}
              className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed md:w-10 md:h-10 w-8 md:ml-2 ml-2 h-8 md:mt-0 mt-1 rounded-full flex items-center justify-center transition-all duration-200"
            >
              {isLoading ? (
